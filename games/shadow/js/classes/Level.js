Shadow.Level = function(game) {
    this.game = game;
};

// Setup the example
Shadow.Level.prototype.create = function() {
...
Shadow.Level.prototype.toggleRays = function() {
...
Shadow.Level.prototype.update = function() {
...
Shadow.Level.prototype.getWallIntersection = function(ray) {
